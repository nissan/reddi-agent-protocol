...
const HARDCODED_TRACE = [
  ...
  },
  {
    ...
    lines: [
      ...
      "→ Placeholder TX id, not a real signature",
  ...
  },
  {
    ...
    lines: [
      ...
      "→ Simulated escrow check (no RPC call)...",
...
<body>
  <div class="hero">
    <h1>[PRODUCT NAME]</h1>
    <p class="sub">Generated by the Reddi Agent Protocol · 4 specialists · scripted demo trace, no on-chain transactions</p>
