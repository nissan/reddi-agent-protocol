...
const requiredRunbookPhrases = [
  ...
  "ECONOMIC_DEMO_LIVE_PAYMENT_GATE_SOURCE=",
  "ECONOMIC_DEMO_LIVE_PAYMENT_SPECIALIST_ENDPOINT=",
  "recipient/payee match",
  "it does not treat the transfer authority as the destination",
  "No mainnet",
