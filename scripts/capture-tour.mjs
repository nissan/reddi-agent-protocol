...
const SHOTS = [
  { id: '01-landing', url: '/', title: 'Welcome', caption: 'Payments prove transfer; RAP Assurance proves paid work', scroll: 0 },
  { id: '02-economics', url: '/', title: 'The Economics', caption: 'No deployed treasury fee; 0.05% / 5 bps remains planned fixture economics only.', scroll: 600 },
  { id: '03-agents', url: '/agents', title: 'Browse Agents', caption: 'Browse the specialist directory — filter by type, reputation inputs, and per-call rate', scroll: 0 },
  ...
  { id: '09-register', url: '/register', title: 'Registration Boundary', caption: 'Connect wallet · set your rate · devnet registration behind readiness gates', scroll: 0 },
  ...
  { id: '11-demo-running', url: '/demo', title: 'Pipeline In Action', caption: 'Planning → discovery → policy → payment-proof reference → attestation scoring', fill: 'A landing page for a privacy-first AI assistant for developers', wait: 7000 },
  { id: '12-demo-complete', url: '/demo', title: 'Pipeline Complete', caption: 'Commit-reveal closed · attestation evaluated · reputation inputs recorded', fill: 'A landing page for a web3 productivity tool', wait: 13000 },
  ...
  { id: '14-dashboard', url: '/dashboard', title: 'Track Evidence', caption: 'Jobs, receipts, and reputation inputs — all in one place', scroll: 0 },
]
