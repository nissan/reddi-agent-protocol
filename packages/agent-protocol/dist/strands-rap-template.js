...
export const STRANDS_RAP_TEMPLATE_SCHEMA_VERSION = 'reddi.strands-rap-template.v1';
...
export function createStrandsRapTemplateFixture(input = {}) {
    ...
    if (!selectedContract.sellerProfile)
        throw new Error('strands_template_missing_seller_profile');
    const fixture = {
...
export function validateStrandsRapTemplate(template) {
