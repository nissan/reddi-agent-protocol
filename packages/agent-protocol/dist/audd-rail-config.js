...
export const SOLANA_MAINNET_BETA_CAIP2 = 'solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp';
export const SOLANA_DEVNET_CAIP2 = 'solana:EtWTRABZaYq6iMfeYKouRu166VU2xqa1';
export const SOLANA_TESTNET_CAIP2 = 'solana:4uhcVJyU9pJkvQyS88uRDiswHXSCkY3z';
export const AUDD_RAIL_CONFIG = {
...
export function isKnownAuddMint(mint) {
...
export function validateAuddRailIdentity(input) {
    ...
    if (errors.length > 0)
        return { ok: false, identity, reasonCodes: unique(errors), auditNotes };
    return {
        ok: true,
        identity,
...
function buildIdentity(config, input) {
    return {
        asset: AUDD_ASSET,
